...
CONFIG = _cleanup(
    {
        "Compilers": {
            ...
            "pythran": {
                "version": "0.13.1",
                "include directory": r"C:\Users\runneradmin\AppData\Local\Temp\pip-build-env-rq9a70cn\overlay\Lib\site-packages/pythran"
            },
        },
        "Machine Information": {
            "host": {
        ...
        "Python Information": {
            "path": r"C:\Users\runneradmin\AppData\Local\Temp\cibw-run-6gd_2ja9\cp39-win_amd64\build\venv\Scripts\python.exe",
            "version": "3.9",
        },
    }
)
